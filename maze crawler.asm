;Code created by Bruno, Enzo and Luca
;the algorithm used to generate random number is an LCG with a=33,b=1 and m=2^16
;the algorithm used to generate the map itself is a random DFS, and is thoroughly explained in:
;cgamming.wordpress.com/2017/06/10/maze-crawler-part-2

;this code is made to run in ICMC's processor, coded for FPGA, which can be found in the repository processador-ICMC of the user simoesusp
...
printInt:
	...
	printInt_print_loop:
		...
		div r2,r2,r3
		cmp r2,r5
		jeq printInt_print_last
		div r4,r4,r2
		add r4,r4,r6
		outchar r4,r1
		inc r1
		jmp printInt_print_loop
	printInt_print_last:
		mod r4,r0,r3
		add r4,r4,r6
		outchar r4,r1
