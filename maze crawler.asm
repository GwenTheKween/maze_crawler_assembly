...
;The code for the random number generation is based on the LCG algorithms
;the map is generated by running a random DFS on the position matrix, and a more readable version can be found in the Maze_crawler repository, in the mapa.cpp file
;an extended explanation on this specific algorithm can be found in https://cgamming.wordpress.com/2017/06/10/maze-crawler-part-2/
